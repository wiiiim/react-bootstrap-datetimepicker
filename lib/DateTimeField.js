...
var DateTimeField = (function (_Component) {
  ...
  function DateTimeField() {
    ...
    var initVal = (0, _moment2["default"])(this.props.dateTime);
    var formattedValue = initVal.isValid() ? initVal.format(this.resolvePropsInputFormat()) : '';
    var defaultDate = (0, _moment2["default"])();
    ...
    this.state = {
      ...
      viewDate: initVal.isValid() ? initVal.startOf("month") : defaultDate,
      selectedDate: initVal.isValid() ? initVal : defaultDate,
      inputValue: typeof this.props.defaultText !== "undefined" ? this.props.defaultText : formattedValue
    };

    this.componentWillReceiveProps = function (nextProps) {
      var state = {};
      
      var nextVal = (0, _moment2["default"])(nextProps.dateTime, nextProps.format, true)
      var formattedValue = nextVal.isValid() ? nextVal.format(nextProps.inputFormat) : '';

      if (nextProps.inputFormat !== _this.props.inputFormat) {
        state.inputFormat = nextProps.inputFormat;
        state.inputValue = formattedValue;
      }
    ...
    this.onChange = function (event) {
      ...
      return _this.setState({
        ...
        var formattedValue = isValueValid ? (0, _moment2["default"])(_this.state.inputValue, _this.state.inputFormat, true).format(this.props.format) : '';
